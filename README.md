...
`ncdu-reader` is a parser for binary exports generated by [NCDU](https://dev.yorhel.nl/ncdu) available since 2.6.
...
`ncdu-reader` is distributed under the terms of the [MIT](https://spdx.org/licenses/MIT.html) license.
